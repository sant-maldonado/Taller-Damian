...
const menuItems = [
  ...
  { path: '/services', label: 'Servicios', icon: 'M11.42 15.17l-5.384 5.384a2.025 2.025 0 01-2.864-2.864l5.384-5.384m2.864 2.864L17.5 9.5m-2.08 5.67l3.5 3.5M6.343 6.343l2.122 2.122m0 0l1.414 1.414M6.343 6.343l-2.122-2.122m12.02 7.778l2.122 2.122m0 0l-2.122 2.122M18.484 14.12l2.122-2.122' },
  ...
  { path: '/hours', label: 'Horas', icon: 'M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z' },
]
  ...
  return (
    <aside className="w-[220px] bg-[#080808] border-r border-white/[0.06] flex flex-col shrink-0 h-screen">
      ...
      <div className="px-5 py-4 border-t border-white/[0.06]">
        <div className="text-[10px] text-white/15 font-medium tracking-wider">v1.0</div>
      </div>
    </aside>
  )
}
