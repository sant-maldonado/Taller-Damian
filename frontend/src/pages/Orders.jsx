      ...
      <div className="card overflow-hidden">
        ...
        : orders.length === 0 ? (
          <EmptyState
            ...
            description={isClient ? "Todavía no tenés trabajos registrados" : "Cuando llega un auto, tocá «+ Nuevo trabajo» y cargá la patente. Listo."}
          >
            {!isClient && (
              <button onClick={openNewModal} className="btn-primary mt-6">+ Nuevo trabajo</button>
            )}
          </EmptyState>
        ) : (
